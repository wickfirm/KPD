...
export default function StaticPageForm({ defaults }: { defaults?: StaticPageDefaults }) {
  ...
  const [management, setManagement] = useState<ManagementPerson[]>(() => aboutValues.management?.length === 3 ? aboutValues.management : aboutFallback.management);
