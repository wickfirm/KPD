...
export default async function HomePage() {
  ...
  // A missing settings row must never send visitors to the old .html URL.
  // The template has meaningful defaults and becomes CMS-driven once settings
  // are saved, so the canonical homepage can always remain `/`.
  home ??= {};
  ...
  return <div className="development-pdf-home" id="top">
    ...
    <section className="pdf-section pdf-contact-block" id="contact"><div><h2>{home.contactHeading || "A first point of contact"}</h2></div><div className="pdf-contact-copy"><p>{home.contactText}</p><Link href="/contact#experience-center">Plan Visit</Link></div></section>
    ...
    <section className="pdf-section pdf-events-head" id="news"><h2>Blogs and updates</h2><div><p>Announcements, market observations, and development commentary.</p><Link href="/news">Explore</Link></div></section>
